...
namespace Assets.Scripts
{
    class ProfileSensor
    {
        ...
        public static void LoadProfile()//从文件中读取配置信息并赋给声明的静态变量
        {
            ...
            _file = new IniFile(Application.streamingAssetsPath + "\\SerialPortSensor.ini");
            ...
            G_PORTNAME = _file.ReadString("CONFIG", "PortName", "COM5");
        ...
        public static void SaveProfile()
        {
            ...
            _file = new IniFile(strPath + "SerialPortSensor.ini");
